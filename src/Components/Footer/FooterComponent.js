                                                    ...
                                                    optionData['contact-social-links'].map((item, index) => (
                                                        <li className="list-inline-item" key={index}>
                                                            <a href={item.link_url} target="_blank" rel="noreferrer">
                                                                {item.link_url.match(/facebook/gi)?<i className="fa fa-facebook-official"></i>:null}
                                                                {item.link_url.match(/twitter/gi)?<i className="fa fa-twitter"></i>:null}
                                                                {item.link_url.match(/dribbble/gi)?<i className="fa fa-dribbble"></i>:null}
                                                                {item.link_url.match(/behance/gi)?<i className="fa fa-behance-square"></i>:null}
                                                                {item.link_url.match(/linkedin/gi)?<i className="fa fa-linkedin-square"></i>:null}
                                                            </a>
                                                        </li>
                                                    ))
                                                }
