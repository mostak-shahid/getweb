                        ...
                        <div className="row">
                            <div className="col-lg-4 wdfh col-sm-6 text-center text-sm-start">
                                <div className="contacts">
                                    <p className="textClrGray fs-14 fw-medium mb-2">Want to collaborate?</p>
                                    <a href={["mailto", optionData["contact-email"][0]].join(":")} className="textClrGreen fs-22 fwSemiBold text-decoration-none">{optionData["contact-email"][0]}</a>
                                </div>
                            </div>
                            <div className="col-lg-4 wdfh col-sm-6 text-center text-sm-start">
                                <div className="contacts">
                                    <p className="textClrGray fs-14 fw-medium mb-2">Want to join us?</p>
                                    <a href={["mailto", optionData["contact-email"][1]].join(":")} className="textClrGreen fs-22 fwSemiBold text-decoration-none">{optionData["contact-email"][1]}</a>
                                </div>
                            </div>
                            <div className="col-lg-4 wdfh text-center text-sm-start">
                                <div className="contacts">
                                    <p className="textClrGray fs-14 fw-medium mb-2">Want to discuss with us?</p>
                                    <div className="btn-wrapper">
                                    <span className="btn-pink btn position-relative border-0 rounded-pill d-flex align-items-center justify-content-center d-none" title="Book a call now"  onClick={()=>setShow(true)}>
                            ...
                            <div className="widget footerimagarea">
                                <div className="row">
                                    <div className="col-12 col-sm-8 col-xl-12 text-center text-sm-start">
                                        ...
                                        <div className="intro textClrGray fs-14 fw-medium mb-4" dangerouslySetInnerHTML={{__html: optionData["sections-footer-content"]}}/>
                                    ...
                                    <div className="col-12 col-sm-4 col-xl-12">
                                        <div className="Careers text-center text-sm-start">
                                            ...
                                            <a href={optionData["sections-footer-career"]} className="text-decoration-none bgClrPink d-inline-flex px-4 py-2 rounded-pill align-items-center gap-2 text-white fwSemiBold fs-13">
                    ...
                    <div className="widget">
                        <div className="row">
                            <div className="col-sm-8">
                                <div className="copyrightText text-center text-sm-start d-block d-sm-flex align-items-sm-center">
