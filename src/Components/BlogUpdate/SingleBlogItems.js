    ...
    return (
        <div className="singleBlog isRadius16 d-flex flex-column justify-content-between">
            <div className="content-part">
                {
                    ...
                    <div className="blogImage">
                        <NavLink to={['/blog',props?.data?.slug].join('/')} className="text-decoration-none"  data-target="#root">
                ...
                <div className="blogInfo p-4">
                    <h3 className="blogTitle fs-6 fw-bold mb-2">
                        <NavLink to={['/blog',props?.data?.slug].join('/')} className="text-decoration-none text-white" dangerouslySetInnerHTML={{__html:props.data.title}}  data-target="#root" />
                    </h3>
            ...
            <div className="link-part p-4 pt-0">
                <NavLink to={['/blog',props?.data?.slug].join('/')} className="readMore d-flex align-items-center fs-14 fwSemiBold text-decoration-none"  data-target="#root" >
                    <span>Read More</span>                    
