...
export default class BannerComponents extends Component {    
    ...
    async componentDidMount() {
        ...
        //console.log(this.state.trustedLogos);
    }
                ...
                <div className="container">
                    <div className="bannerContent d-flex align-items-center position-relative">
                        <div className="content text-center">
                            <div className = "bannerTitle text-white fs-72 fw-normal mb-4 pb-2" dangerouslySetInnerHTML = {{__html: this.state.bannerData.meta.banner_title}}></div>
                            ...
                            <div className="gw-btn d-flex justify-content-center">
                                <NavLink to={this.state.bannerData.meta.banner_button_url} className="btn position-relative text-dark border-0 py-2 px-4 rounded-pill fwSemiBold fs-15 h-52 gap-2 d-flex align-items-center justify-content-center">
                                    <span className="me-4">{this.state.bannerData.meta.banner_button_title}</span>
                    ...
                    {Object.values(this.state.bannerData.meta.banner_gallery).map(( value , index)=> {
                        return (
