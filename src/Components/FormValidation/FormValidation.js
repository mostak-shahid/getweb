                        ...
                        <div className="col-lg-12 mb-3">
                            <div className="contactField">
                                ...
                                <div className="countryCode d-flex align-items-center rounded-pill border overflow-hidden">
                                    ...
                                    <input placeholder="Please enter your number" type="tel" id="formBasicContactNumber" className="rounded-0 border-0 border-start px-3 form-control" {...register('phone', {onChange: handleChange})}/>
                                </div>                                
                    ...
                    }
                    {
                        ...
                        <div className="col-sm-6 mb-20">
                            <div className="contactField">
                                ...
                                <select className="rounded-pill px-4 form-control form-select" id="formBasicName" {...register('interested',{ required: true})}>
                                ...
                                {errors.interested?.type === "required" && <div className='text-danger mt-1'>Please select one.</div>}
                            </div>
                        </div>
                    }
                    {
                        ...
                        <div className="col-sm-6 mb-20">
                            <div className="contactField">
                                ...
                                <select className="rounded-pill px-4 form-control form-select" id="formBasicEmail" {...register('budget',{ required: true})}>
                                    <option value="">Select</option>
                                ...
                                {errors.budget?.type === "required" && <div className='text-danger mt-1'>Budget is required.</div>}
                            </div>
                        </div>
                    }
                    {
